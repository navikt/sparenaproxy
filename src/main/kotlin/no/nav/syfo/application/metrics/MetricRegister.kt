...
val OPPRETTET_PLANLAGT_MELDING: Counter =
    Counter.Builder()
        .namespace(METRICS_NS)
...
val MOTTATT_AKTIVERMELDING: Counter =
    Counter.build()
        .namespace(METRICS_NS)
...
val SENDT_MAKSDATOMELDING: Counter =
    Counter.build()
        .namespace(METRICS_NS)
        .name("sendt_maksdato_counter")
        .help("Antall sendte maksdatomeldinger")
        .register()

val IKKE_FUNNET_MELDING: Counter =
    Counter.build()
        .namespace(METRICS_NS)
...
val KVITTERING_MED_FEIL: Counter =
    Counter.build()
        .namespace(METRICS_NS)
