...
class MottattSykmeldingServiceTest :
    FunSpec({
        ...
        val mottattSykmeldingService = MottattSykmeldingService(testDb, syfoSyketilfelleClient)
        ...
        context("Test av behandling av mottatt sykmelding") {
            test("Ignorerer sykmelding uten tilhørende planlagte meldinger") {
                ...
                coVerify(exactly = 0) {
                    syfoSyketilfelleClient.getStartDatoForSykmelding(any(), any())
                }
            ...
            test(
                ...
                coEvery { syfoSyketilfelleClient.getStartDatoForSykmelding(any(), any()) } returns
