    ...
    FunSpec({
        ...
        beforeTest {
            ...
            testDb.connection.lagrePlanlagtMelding(
                opprettPlanlagtMelding(
                    ...
                    avbrutt = OffsetDateTime.now(Clock.tickMillis(ZoneOffset.UTC)).minusWeeks(3)
                )
            )
            testDb.connection.lagrePlanlagtMelding(
                opprettPlanlagtMelding(
        ...
        context("Test av behandling av mottatt sykmelding") {
            ...
            test(
                ...
                coEvery { syfoSyketilfelleClient.finnStartdato(any(), any(), any()) } returns
            ...
            test(
                ...
                coVerify(exactly = 0) { arenaMeldingService.sendPlanlagtMeldingTilArena(any()) }
                val meldinger =
                    testDb.connection.hentPlanlagtMelding("12345678910", LocalDate.of(2020, 3, 25))
            ...
            test(
                ...
                val meldinger =
                    testDb.connection.hentPlanlagtMelding("11223344556", LocalDate.of(2020, 3, 30))
                meldinger.size shouldBeEqualTo 2
        ...
        context("Test av logikk for om sykmelding er gradert") {
            test("Sykmelding uten gradert periode inneholder ikke gradert periode") {
                ...
                val inneholderGradertPeriode =
                    mottattSykmeldingService.inneholderGradertPeriode(perioder)
            ...
            test(
                "Sykmelding med flere perioder inneholder gradert periode hvis en av periodene er gradert"
            ) {
                val perioder: List<Periode> =
                    listOf(
                        Periode(
