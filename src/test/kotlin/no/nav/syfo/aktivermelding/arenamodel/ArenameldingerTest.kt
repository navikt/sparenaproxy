...
class ArenameldingerTest :
    FunSpec({
        ...
        val n281039uker =
            N2810(dato = "19062020", klokke = "235157", fnr = "12345678910", meldKode = "I")
        val n283039uker =
            N2830(
                meldingId = "M-F226-1  ",
                versjon = "015",
        ...
        context("39-ukersmelding får riktig tekstverdi") {
            test("N2810 får riktig tekstverdi") {
                ...
                n2810SomTekst shouldBeEqualTo
                    "N2810   SENDMELDINGSPEIL        0048219062020235157    12345678910  SPI "
            }
            test("N2830 får riktig tekstverdi") {
                val n2830SomTekst = n283039uker.tilTekst()

                n2830SomTekst shouldBeEqualTo
                    "N2830   00001M-F226-1  01502052020                                                                                  " // lengde 116
            }
            test("N2840 får riktig tekstverdi") {
                val n2840SomTekst = n284039uker.tilTekst()

                n2840SomTekst shouldBeEqualTo
                    "N2840   00001SP: 39 ukersbrevet er dannet. Brevet sendes fra Arena (via denne hendelsen).    " // lengde 93
            }
            test("39-ukersmelding får riktig tekstverdi") {
                val brev39UkerMqMelding = brev39UkerMelding.tilMqMelding()

                brev39UkerMqMelding shouldBeEqualTo
                    "N2810   SENDMELDINGSPEIL        0048219062020235157    12345678910  SPI " +
                        "N2820   00001                                                                                                                                                                                            " +
