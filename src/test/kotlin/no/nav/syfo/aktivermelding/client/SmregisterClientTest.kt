...
class SmregisterClientTest :
    FunSpec({
        ...
        val smregisterClient =
            SmregisterClient(mockHttpServerUrl, accessTokenClientMock, "resourceId", httpClient)
        ...
        context("Test av SmRegisterClient - 100% sykmeldt") {
            ...
            test("Er ikke 100% sykmeldt hvis sykmeldt, men gradert") {
                val erSykmeldt =
                    smregisterClient.er100ProsentSykmeldt("fnr-gradert", UUID.randomUUID())

                erSykmeldt shouldBeEqualTo false
            }
            test("Er ikke 100% sykmeldt hvis ikke lenger sykmeldt") {
                val erSykmeldt =
                    smregisterClient.er100ProsentSykmeldt("fnr-ikkesyk", UUID.randomUUID())
        ...
        context("Test av SmRegisterClient - sykmeldt til og med-dato") {
            ...
            test("Tom-dato er null hvis ikke lenger sykmeldt") {
                val sykmeldtTom =
                    smregisterClient.erSykmeldtTilOgMed("fnr-ikkesyk", UUID.randomUUID())
