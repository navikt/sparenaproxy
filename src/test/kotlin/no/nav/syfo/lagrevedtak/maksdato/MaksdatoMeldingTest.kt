...
object MaksdatoMeldingTest : Spek({
    ...
    describe("Maksdatomelding får riktig tekstverdi") {
        it("K278M810 får riktig tekstverdi") {
            ...
            k278M810SomTekst shouldEqual "K278M810SENDMELDINGSPEIL        0048219062020235157    12345678910  SPI "
        }
        ...
        it("K278M830 får riktig tekstverdi") {
            ...
            k278M830SomTekst shouldEqual "K278M83000001M-SPVT-1  0052805202027052021998899889                                                                 " // lengde 116
        }
        it("K278M840 får riktig tekstverdi") {
            val k278M840SomTekst = K278M840().tilTekst()

            k278M840SomTekst shouldEqual "K278M84000001SP: SP, max.dato sykepenger                                                     " // lengde 93
        }
        it("Maksdatomelding får riktig tekstverdi") {
            val maksdatoMqMelding = maksdatoMelding.tilMqMelding()

            maksdatoMqMelding shouldEqual "K278M810SENDMELDINGSPEIL        0048219062020235157    12345678910  SPI " +
                    "K278M81500001                                                                                                                                                                                            " +
